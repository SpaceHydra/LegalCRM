    ...
    resetToDefaultData() {
        const defaultData = {
            ...
            opportunities: [
                {
                    id: 'OPP-2025-0001',
                    dealName: 'HDFC - Litigation & BPR CRM',
                    ...
                    owner: 'Akash Mehta',
                    probability: 70,
                    sourceLeadId: 'LD-2025-0001',
                    sourceLeadName: 'Rajesh Kumar',
                    region: 'West',
                    industry: 'Banking',
                    status: 'Open',
                    ...
                    nextAction: 'Follow up with commercial negotiation in 3 days',
                    competitors: ['Zoho CRM', 'Salesforce'],
                    proposalSentDate: '2025-11-14'
                },
                {
                    id: 'OPP-2025-0002',
                    dealName: 'SNG - Legal CRM',
                    accountId: 'ACC-2025-002',
                    accountName: 'SNG Partners',
                    ...
                    owner: 'Priya Nair',
                    probability: 60,
                    sourceLeadId: 'LD-2025-0002',
                    sourceLeadName: 'Meera Shah',
                    region: 'North',
                    industry: 'Legal',
                    status: 'Open',
                    createdDate: '2025-11-10',
                    createdBy: 'Priya Nair',
                    primaryContact: 'Meera Shah',
                    contactEmail: 'meera.shah@sngpartners.com',
                    contactPhone: '99887 76655',
                    nextAction: 'Finalize proposal and send for review',
                    competitors: ['LawRato', 'Vakilsearch'],
                    proposalSentDate: null
                },
                {
                    id: 'OPP-2025-0003',
                    dealName: 'SBI - Advocate Portal',
                    ...
                    owner: 'Saurabh Jain',
                    probability: 75,
                    sourceLeadId: 'LD-2025-0003',
                    sourceLeadName: 'Anjali Singh',
                    region: 'North',
                    industry: 'Banking',
                    status: 'Open',
                    createdDate: '2025-11-05',
                    createdBy: 'Saurabh Jain',
                    primaryContact: 'Anjali Singh',
                    contactEmail: 'anjali.singh@sbi.co.in',
                    contactPhone: '98111 22233',
                    nextAction: 'Commercial discussion with procurement team',
                    competitors: ['SAP', 'Oracle'],
                    proposalSentDate: '2025-11-10'
                },
                {
                    id: 'OPP-2025-0004',
                    dealName: 'RBI - Compliance Suite',
                    accountId: 'ACC-2025-004',
                    accountName: 'Reserve Bank of India',
                    ...
                    primaryContact: 'Dr. Rajiv Mehta',
                    contactEmail: 'rajiv.mehta@rbi.org.in',
                    contactPhone: '99000 11122',
                    nextAction: 'Awaiting final commercial approval from CFO',
                    competitors: [],
                    proposalSentDate: '2025-10-25'
                },
                {
                    id: 'OPP-2025-0005',
                    dealName: 'Kotak - BPR Only',
                    accountId: 'ACC-2025-005',
                    accountName: 'Kotak Mahindra Bank',
                    ...
                    owner: 'Akash Mehta',
                    probability: 0,
                    sourceLeadId: 'LD-2025-0010',
                    sourceLeadName: 'Sanjay Gupta',
                    region: 'West',
                    industry: 'Banking',
                    status: 'Lost',
                    ...
                    contactEmail: 'sanjay.gupta@kotak.com',
                    contactPhone: '98765 99999',
                    nextAction: null,
                    competitors: ['TCS', 'Infosys'],
                    proposalSentDate: '2025-10-05',
